...
echo "Created table 'Venue FormFields'..." . PHP_EOL;

if (!$schema->hasTable('event_venue')) {
    echo "Creating  Table 'event_venue'..." . PHP_EOL;
    ...
    echo "Created table 'Venue'..." . PHP_EOL;
} else {
    echo "Table 'Venue' already exists.  Skipping..." . PHP_EOL;
}